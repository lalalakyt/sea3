...
<div>
  <ul>
    ...
    <li>城市內不同場景的對話內容整理（尚未全部完成），包含中文化後的內容有被修正（河蟹？）的資料，以及翻譯錯誤的說明。</li>
    <li>發現物和各事件的劇情對話。</li>
    <li>遊戲背景的相關歷史和地理資料。包含人物、贊助人、國家、線索書籍以及發現物的相關介紹。</li>
    <li>遊戲修改資訊。</li>
    <li>其他各種關於這個遊戲的資訊（太多就不細列了）。</li>
    <li>我的兩次遊戲的歷程記錄及說明（仍然進行中）。</li>
  </ul>
</div>
